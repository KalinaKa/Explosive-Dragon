...
# tu warto pamietac, jesli robisz jakas operacje wiecej niz raz, zrob sobie zmienna
...
# listy mozna nazywac liczba mnoga, jesli tak - to pojedynczy element z lilsty bedzie sie tak nazywal jak z l.mn
