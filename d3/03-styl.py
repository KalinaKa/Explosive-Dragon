...
#hard coding - normalnie nie używamy, zwykle z pliku lub od usera
...
#jesli chcesz przeniesc dlugie frazy do nastepnej linii: ukosnik na koncu, operator do nowej linii
rownanie = 3 \
           + 3 \
           + 5
